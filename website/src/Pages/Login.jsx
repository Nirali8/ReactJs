...
const Login = () => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center close">
      <div className="bg-white w-full max-w-lg mx-4 p-8  rounded-lg shadow-lg relative">
        ...
        <form>
          ...
          <div className="mb-6">
            <a
              href="#"
              className="text-sm text-gray-500 underline hover:text-lime-500"
            >
